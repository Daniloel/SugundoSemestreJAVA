...
public class Carro {
	...
	// Atributos da classe que no caso Ã© o carro
	String placa;
	int ano;
	String cor;
	String marca;
	...
	public Carro(String placa, int ano, String cor, String marca) {
		// this necessario quando nomes são iguais ao de atributo e argumento
		this.placa = placa;
		this.ano = ano;
		this.cor = cor;
		this.marca = marca;
	...
	// métodos de acesso do tipo setter(colocar o valor na variavel), Fonerce o
	...
	// métodos de acesso do tipo getter pego os valores que são colocados pelo
	// usuario
